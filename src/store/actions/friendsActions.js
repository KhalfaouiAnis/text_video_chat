...
export const sendFriendInvitation = (data, closeDialogHandler) => {
  return async (dispatch) => {
    ...
    if (response.error) {
      ...
      dispatch(openAlertMessage("Invitation has been sent !", "success"));
      closeDialogHandler();
    }
  };
};
...
export const acceptFriendInvitation = (data) => {
  return async (dispatch) => {
    ...
    if (response.error) {
      ...
      dispatch(openAlertMessage("Invitation Accepted !", "info"));
    }
  };
};
...
export const rejectFriendInvitation = (data) => {
  return async (dispatch) => {
    ...
    if (response.error) {
      ...
      dispatch(openAlertMessage("Invitation Declined !", "warning"));
    }
  };
};
